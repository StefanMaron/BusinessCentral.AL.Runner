...
codeunit 66301 "XSIX Tests"
{
    Subtype = Test;
    TestPermissions = Disabled;

    var
        Assert: Codeunit "XSIX Assert";
    ...
    begin
        Assert.IsTrue(XmlPortMetadata.Get(66300), 'XMLport Metadata in group X must list xmlport 66300, which this group declares');
    end;
}
