...
**Commenting on issues in this repository is ungated** — `.claude/rules/public-posting-approval.md`. Post the comments this agent's steps call for without asking; each carries its reasoning and says an agent wrote it.
