...
**Why:** assumption-based "fixes" produce ghost tests that pass against a wrong mental model. The patch ships green, the real bug stays, and the test suite gains noise.
